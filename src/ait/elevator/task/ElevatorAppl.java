...
public class ElevatorAppl {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println("CurrentVolume " + elevator1.getName() + " " + elevator1.getCurrentVolume());
        System.out.println("CurrentVolume " + elevator2.getName() + " " + elevator2.getCurrentVolume());
